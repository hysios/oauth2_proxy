...
1. Download [Prebuilt Binary](https://github.com/hysios/oauth2_proxy/releases) (current release is `v2.2`) or build with `$ go get github.com/hysios/oauth2_proxy` which will put the binary in `$GOROOT/bin`
